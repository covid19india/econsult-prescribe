...
jQuery(document).ready(function() {
	...
	*/
	...
	$('#medications_step').on('click', function () {
		...
		if (
			!(
				verifyAllFilled(data) &&
				data.length == 4 * $('#medicine_group .medicine').length
			)
		) {
			alert('Please fill out all the fields correctly before proceeding.');
		} else {
		...
		html +=
			...
			'" class="form-control" required> \
			        ...
			        <div class="form-group short"> \
			            ...
			            <input type="number" placeholder="2" name="duration_ ' +
			medicine_count +
			'" class="form-control short" required> \
			        </div> \
			        <br> \
			        <div class="radio-buttons-1"> \
			        	<label>Frequency (per day):</label><br> \
			            <label class="radio-inline"> \
			            	<input type="radio" name="frequency_' +
			medicine_count +
			'" value="1" required> 1 time(s) \
			            </label> \
			            <label class="radio-inline"> \
			            	<input type="radio" name="frequency_' +
			medicine_count +
			...
			'" value="3"> 3 time(s) \
			        ...
			        <div class="radio-buttons-1"> \
			            ...
			            <label class="radio-inline"> \
			            	<input type="radio" name="usage_' +
			medicine_count +
			'" value="Before meal(s)" required> Before meal(s) \
			            </label> \
			            <label class="radio-inline"> \
			            	<input type="radio" name="usage_' +
			medicine_count +
			'" value="After meal(s)"> After meal(s) \
			            </label> \
			            <label class="radio-inline"> \
			            	<input type="radio" name="usage_' +
			medicine_count +
			'" value="Empty stomach"> Empty stomach \
			            </label> \
					</div> \
					<br> \
